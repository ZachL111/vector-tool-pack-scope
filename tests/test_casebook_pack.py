"""Regression checks for the vector-tool-pack-scope casebook."""
...
from casebook.harness import assert_expected, vector_tool_pack_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vector_tool_pack_scope_summary(), assert_expected())
